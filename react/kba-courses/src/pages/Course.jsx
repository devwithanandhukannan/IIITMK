    ...
    return (
        <>
            ...
            <div className="bg-white text-gray-900 mb-10 pb-10">
                ...
                <div className="flex flex-row justify-end gap-4 pr-5 max-w-4xl mx-auto">
                    <Link to="/edit-course" className="bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full h-10 px-6 focus:outline-none focus:shadow-outline">
                        Edit Course
                    </Link>
                    <button className="bg-red-500 hover:bg-red-600 text-white font-bold rounded-full h-10 px-6 focus:outline-none focus:shadow-outline">
                        Remove Course
                    </button>
                </div>
            </div>
